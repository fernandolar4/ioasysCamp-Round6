  ...
  return (
    <>
      ...
      <S.sobreEmpresa>
          ...
          <section className="containerSobre">
            ...
            <div>
              <article>
                ...
                <p>
                  A Cobé é uma empresa de turismo de base comunitária que tem
                  como foco a experiência do viajante no local de destino. A
                  viagem é toda planejada para que a pessoa participe do dia a
                  dia da comunidade local, realizando as mesmas atividades que
                  os moradores realizam, além de ter a oportunidade de conhecer
                  os costumes da região.
                </p>
                <p>
                  O nosso objetivo principal é ajudar comunidades rurais através
                  do turismo, proporcionando desenvolvimento da economia das
              ...
              <article>
                ...
                <p>
                  ...
                  comunidade, faz as refeições junto com a família e participa
                  da rotina de atividades com essa família. Ele pode aprender e
                  ajudar com o plantio, a cozinha, trabalhando com peças de
                  artesanado tradicionais na comunidade, entre várias outras
                  atividades.
                </p>
                <p>
                  A ideia é colocar as comunidades locais como protgonistas e
                  promover um estilo de viagem sustentável, com respeito à
                  natureza, às populações e à cultura.
                </p>
              </article>
            </div>
          </section>
        ...
        <section className="containerObjetivo">
          <div className="containerBgB"></div>
          <h2 className="tituloProposito">Nosso propósito</h2>
          <img
            src={img2}
          ...
          <div>
            ...
            <article>
              ...
              <p>
                Foi ai que decidimos incentivar o turismo comunitário no Brasil:
                é uma alternativa de renda para populações dessas comunidades,
                uma oportunidade de valorização da cultura local e uma forma de
